...
const char f_bld4[] PROGMEM = "home.bld4";
...
const char* const nx_pwm_names[] PROGMEM {pwm_1_name,pwm_2_name,pwm_3_name,pwm_4_name,pwm_5_name,pwm_6_name,pwm_7_name,pwm_8_name};
